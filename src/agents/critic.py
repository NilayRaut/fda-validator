...
_SYSTEM = (
    ...
    "if a lens has no supporting evidence (common for investigational drugs absent from these "
    "databases), state that plainly. Finish with a final line exactly in the form "
    "'VERDICT: supports' or 'VERDICT: contradicts' or 'VERDICT: silent', reflecting whether your "
    "independent evidence supports, contradicts, or is silent on the researcher's conclusion."
)
